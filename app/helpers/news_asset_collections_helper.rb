module NewsAssetCollectionsHelper
  ...
  def link_to_add_field(name, f)
    ...
    collection = "<div class=\"thumbnail fields\"><img alt=\"Default image\" data-target=\"#modalnew_collection\" data-toggle=\"modal\" src=\"#{image_path "default_image.gif"}\"><a class=\"btn btn-default\" href=\"#\" onclick=\"NewsAsset.remove_fields(this); return false;\">Remove</a></div>"
